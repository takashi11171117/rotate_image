...
riot.tag2('rotateimage', '<div class="{rotate_image_container: true, fade: is_container}"> <div class="rotate_button"> <button type="button" name="left" onclick="{rotateLeft}">左に</button> <button type="button" name="right" onclick="{rotateRight}">右に</button> </div> <div class="rotate_image"></div> <div class="delete_button"> <button type="button" name="save" onclick="{saveImage}">保存</button> <button type="button" name="delete" onclick="{deleteImage}">削除</button> </div> </div>', 'rotateimage .rotate_image,[data-is="rotateimage"] .rotate_image{ width: 200px; } rotateimage .rotate_image img,[data-is="rotateimage"] .rotate_image img{ width: 200%; height: auto; } rotateimage div,[data-is="rotateimage"] div{ transition: all .2s; opacity: 1; } rotateimage .fade,[data-is="rotateimage"] .fade{ opacity: 0; }', '', function (opts) {
    var _this = this;

    this.is_container = false, this.count = 0, this.rotate = 0, this.now_rotate = 0, this.width = 0, this.height = 0, this.rotate_img = document.getElementsByClassName("rotate_image"), this.rotate_image_container = document.getElementsByClassName("rotate_image_container"), this.img = new Image(), this.org_img = new Image();

    var loadimg = function loadimg(_ref) {
        var src = _ref.src;
    ...
    loadimg({
        ...
        _this.rotate_img[0].appendChild(img);
    });
    ...
    this.saveImage = function () {
        ...
        var url = 'http://192.168.33.10/vagrant/js_test/rotate_image/ajax.php';
        fetch(url, {
            method: 'POST',
            headers: {
